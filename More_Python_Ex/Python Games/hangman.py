...
def get_guessed_word(secret_word, letters_guessed):
    ...
    '''
    # FILL IN YOUR CODE HERE AND DELETE "pass"
    partial_guess_word = "_"*len(secret_word)
    guess_word = list(partial_guess_word)
    secretWord = list(secret_word)
    
    for i in range(len(letters_guessed)):
        for j in range(len(secretWord)):
            if secretWord[j] == letters_guessed[i]:
                guess_word[j] = letters_guessed[i]
...
def hangman(secret_word):
   ...
   #print("-----------------------------")
    ...
    while tries - incorrect_guesses > 0:
        if is_word_guessed(secret_word, letters_guessed) == True:
            ...
            print("-----------------------------")
            print("You have",tries - incorrect_guesses,"guesses left.")
